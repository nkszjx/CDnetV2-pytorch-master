...
from CDnetv2_model import CDnetV2
# from CDnetV2_model_2021 import CDnetV2
...
CHECKPOINT_DIR = './checkpoints/checkpoints_zy3_CDnetV2/'
...
def main():
    ...
    model.load_state_dict(torch.load('./checkpoints/checkpoints_zy3_CDnetV2_1W_8W/VOC_80000.pth'))	
    ...
    #for i_iter in  range(60001, args.num_steps+1):
        ...
        loss_aux = loss_calc(pred_aux, labels) 		



		
        loss_ce = loss_pred + 1*loss_aux
        ...
        if i_iter %20 ==0:
            ...
            print('iter={0:5d},l_ce={1:.3f}, l_pred={2:.3f}, l_aux={3:.3f}'.format(i_iter, loss_ce_value,loss_pred_value, loss_aux_value))
